 ...
 *
 * Prevents MySQL max_allowed_packet errors when generatedhtml, generatedjson,
 * scanneddata or volumebreakdown exceed 512 KB.
 *
...
class manifest_storage {
    ...
    public static function compress(?string $data): ?string {
        ...
        error_log('[CI SAVE] Compressed ' . strlen($data) . ' B → ' . strlen($result) . ' B');
        return $result;
    }
